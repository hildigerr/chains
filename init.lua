...
minetest.register_node("chains:chain", {
    ...
    paramtype = "light",
    drops = "",
    inventory_image = "chains_chain_inv.png",
    tile_images = { "chains_chain.png" },
    drawtype = "plantlike",
    on_place = place_rope,
...
minetest.register_node("chains:chain_top", {
    ...
    paramtype = "light",
    drops = "",
    tile_images = { "chains_chain_top.png" },
    drawtype = "plantlike",
    groups = {cracky=3},
    sounds =  default.node_sound_stone_defaults(),
    })
...
minetest.register_node("chains:chandelier", {
    ...
    paramtype = "light",
    drops = "",
    tile_images = { {name="chains_chandelier_animation.png", animation={type="vertical_frames", aspect_w=96, aspect_h=64, length=16.0}}},
    inventory_image = "chains_chandelier.png",
    wield_image = "chains_chandelier.png",
    drawtype = "plantlike",
    groups = {cracky=3},
    sounds =  default.node_sound_stone_defaults(),
    })
